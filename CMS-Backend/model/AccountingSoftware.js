...
const accountingSoftwarePageSchema = new mongoose.Schema(
    {
        draft: {
            type: Boolean,
        },
...
const AccountingSoftwarePage = mongoose.model('accountingsoftwarepage', accountingSoftwarePageSchema);

module.exports = AccountingSoftwarePage;