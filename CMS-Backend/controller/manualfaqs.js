...
const Faq = require('../model/ManualFaqModal');
const _ = require('lodash');
const cloudinary = require('cloudinary');
// const { isSeller } = require('../middleware/auth');
const catchAsyncErrors = require('../middleware/catchAsyncErrors');
const { cacheMiddleware, flushManualFaq } = require('../middleware/cacheMiddleware');


router.get('/manualfaq-list', catchAsyncErrors(async (req, res) => {
...
router.post('/compose', flushManualFaq, catchAsyncErrors(async (req, res) => {
    try {
...
// blog edit by id
router.get('/manualfaq/edit/:id', catchAsyncErrors(async (req, res) => {
...
router.put('/update/:id', flushManualFaq, catchAsyncErrors(async (req, res) => {
    try {
...
router.get('/manualfaq/:publish', catchAsyncErrors(async (req, res) => {
    try {
...
router.delete('/delete-Img/:blogId', flushManualFaq, catchAsyncErrors(async (req, res) => {
    try {
