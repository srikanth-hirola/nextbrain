  ...
  return (
   ...
   <div className="terms-main">
    ...
    <div className="terms-container" ref={containerRef}>
        <h1 ref={(el) => (textRefs.current[0] = el)}>Privacy Policy</h1>
        <p ref={(el) => (textRefs.current[1] = el)}>
          Welcome to NextBrain, your trusted electric scooter company. Please read our Privacy Policy carefully before using our services:
        </p>

        <div className="terms-content">
          <h2 ref={(el) => (textRefs.current[2] = el)}>1. Agreement to Terms</h2>
          <p ref={(el) => (textRefs.current[3] = el)}>
            By using our website or services, you agree to be bound by these Privacy Policy. If you do not agree, please do not use our platform.
          </p>
