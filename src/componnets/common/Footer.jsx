  ...
  return (
    <div>
          ...
          <div className="scroll-target">
            <div
              data-w-id="17d30ab7-5c0d-0a75-d46a-1f1c824b8664"
                    ...
                    <div className="padding-vertical padding-xxlarge">
                      <div className="padding-bottom padding-xxhuge">
                        <div className="w-layout-grid footer_top-wrapper">
                          <a
                            href="#"
                            id="w-node-_17d30ab7-5c0d-0a75-d46a-1f1c824b866c-824b8664"
                            className="footer_logo-link w-nav-brand"
                            ><div
                              data-w-id="b80327d3-c22e-46c5-ec41-5b26bfe58f9d"
                          ...
                          <div className="footer_link-list">
                            <a
                              ...
                              >Home</a
                            ><a href="/subscription" className="footer_link"
                              >Subscription</a
                          ...
                          <div className="footer_right-wrapper">
                            <div className="margin-bottom margin-small">
                              <div className="text-size-small">
                                Join the ride. 149€/month &amp; not a single
                                thing to worry about
                              </div>
                            </div>
                            <div className="margin-bottom margin-xsmall">
                              <div
                                data-w-id="17d30ab7-5c0d-0a75-d46a-1f1c824b867e"
                                className="button is-secondary is-alternate"
                              >
                      ...
                      <div className="padding-top padding-medium">
                        <div className="footer_bottom-wrapper">
                          <div className="w-layout-grid footer_legal-list">
                            <div
                              id="w-node-_17d30ab7-5c0d-0a75-d46a-1f1c824b8686-824b8664"
                            ...
                            ><a
                              ...
                              >Credits: HIROLA INFOTECH SOLUTIONS PVT LMTD</a
                            >
                            <div
                              fs-cc="manager"
                              className="footer_legal-link-wrapper"
                            >
                              <a
